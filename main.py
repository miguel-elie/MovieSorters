...
sortingTimeMerge = timeit.timeit(code_segment_merge, number=5)
sortingTimeQuick = timeit.timeit(code_segment_quick, number=5)
print(f"Merge Sort Time: {sortingTimeMerge:.04f} seconds")
print(f"Quick Sort Time: {sortingTimeQuick:.04f} seconds")
